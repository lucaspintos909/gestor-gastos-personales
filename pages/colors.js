      ...
      <main className="bg-dark-primary">
        ...
        <div className="grid w-10/12 m-5">
            <div className="grid grid-cols-2 gap-2 w-10/12">
                <div className="transition ease-in-out delay-300 flex flex-row gap-1 bg-dark-secundary rounded-lg p-4 outline outline-offset-1 outline-transparent hover:outline-accent">

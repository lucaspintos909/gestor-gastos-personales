      ...
      <main className="bg-dark-primary">
        ...
        <div className="grid w-10/12 m-5">
            <div className="grid grid-cols-2 gap-2 w-10/12">
                ...
                <div className="flex flex-row gap-1 bg-dark-secundary rounded-lg p-4 outline outline-offset-1 outline-transparent hover:outline-accent">
                    <div className="w-20 h-20 bg-blue rounded-lg"></div>
                    <h2 className="text-white-self font-bold  text-center whitespace-normal">&quot;blue&quot; : AZUL </h2>
                </div>
                <div className="flex flex-row gap-1 bg-dark-secundary rounded-lg p-4 outline outline-offset-1 outline-transparent hover:outline-accent">
                    <div className="w-20 h-20 bg-blue-desat rounded-lg"></div>
                    <h2 className="text-white-self font-bold  text-center whitespace-normal">&quot;blue-desat&quot; : AZUL triste :&apos( </h2>
                </div>
            </div>
        </div>
      </main>
